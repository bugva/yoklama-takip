...
export function Dashboard({
  ...
  return (
    <div className="screen home">
      ...
      {view === 'gpa' && (
        <GpaCalculator scheduleCourses={scheduleCourseNames} />
      )}
      ...
      {view === 'settings' && (
        <section className="stg">
          ...
          <div className="card stg-card">
            ...
            <button type="button" className="stg-list-btn stg-list-btn--danger" onClick={() => { if (window.confirm('GPA verilerini sıfırlamak istiyor musun? Bu işlem geri alınamaz.')) { localStorage.removeItem('gpa-v5'); window.location.reload() } }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 22 7 12 12 2 7"/><polyline points="22 7 22 13"/><path d="M6 10.5v5a6 6 0 0 0 12 0v-5"/></svg>
              <span>GPA Verilerini Sıfırla</span>
              <svg className="stg-chev" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><polyline points="9 18 15 12 9 6"/></svg>
            </button>
          </div>
